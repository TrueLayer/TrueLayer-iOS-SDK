...
#ifndef TRUELAYERUI_SWIFT_H
#define TRUELAYERUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrueLayerUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface TrueLayerUIResources : NSObject
...
SWIFT_CLASS("_TtCOO11TrueLayerUI2UI16CountrySelection4View")
...
@interface View (SWIFT_EXTENSION(TrueLayerUI)) <UISearchResultsUpdating>
