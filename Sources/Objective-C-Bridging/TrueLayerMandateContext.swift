...
@objc
final public class TrueLayerMandateContext: NSObject {
  ...
  @objc
  public let preferences: TrueLayerMandatePreferences
  ...
  public init(
    ...
    token: String,
    redirectURL: URL,
    preferences: TrueLayerMandatePreferences
  ) {
  ...
  func sdkContext() -> TrueLayer.Payments.Models.Mandate.Context {
    TrueLayer.Payments.Models.Mandate.Context(
